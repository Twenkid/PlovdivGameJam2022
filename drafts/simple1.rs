//Base: bevy_config_cam/examples/simple.rs
//Added code to access meshes from the structure, but there's an error with struct MyAssetPack(Handle<Gltf>);
/*
...
Examples for accessing sub-resources in a gltf:
  
https://bevy-cheatbook.github.io/features/gltf.html#gltf-master-asset

Originally it's with named meshes or nodes.

gltf.named_meshes["drone with holes_drone body_0.007"]
gltf.named_nodes["..."]

See in:
  C:\Rust\bevy\assets\models\drone\drone.gltf  (etc.)
   "mesh" : 9,
   "name" : "props_1_front_left_drone body_0"
  etc.
*/
